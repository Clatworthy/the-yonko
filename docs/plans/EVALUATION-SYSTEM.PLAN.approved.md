...
**Status:** APPROVED (human 2026-08-04). Ownership: capture → measurement → effectiveness → ledger projection. No circular capture↔ledger.  
**Skill root:** `~/.cursor/skills/the-yonko/`  
**VERSION:** **3.9.0** (landed)  
...
Approved and implemented. Plan review session: `~/.cursor/yonko-sessions/yonko-eval-system-plan`.

**Phase 1 ownership (decisive):** `capture_session_observability()` → measurement → effectiveness → ledger projection. No circular capture↔ledger.
